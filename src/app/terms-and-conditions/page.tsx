  ...
  return (
    <section className="container space-y-6 bg-slate-50 py-8 dark:bg-transparent md:py-12 lg:py-24">
      <div className="mx-auto flex max-w-[48rem] flex-col">
        ...
        <p className="mb-12">
          These terms and conditions outline the rules and regulations for the use of ZameenVisit's
        ...
        <p className="mb-12">
          Unless otherwise stated, ZameenVisit and/or its licensors own the intellectual property
        ...
        <p className="mb-12">
          We shall not be hold responsible for any content that appears on ZameenVisit. You agree to
          protect and defend us against all claims that may rise on ZameenVisit.
        </p>
        ...
        <p className="mb-12">
          ...
          website. You approve to immediately remove all links to our ZameenVisit website upon
          request.
        </p>
      </div>
    </section>
