    ...
    <section className="container space-y-6  py-8 dark:bg-transparent md:py-12 lg:py-24">
      <div className="mx-auto flex max-w-[48rem] flex-col">
        ...
        <p className="mb-12">
          ...
          use of ZameenVisit&apos;s Website. By using this website, you accept
          these terms and conditions in full. If you disagree with these terms
          and conditions or any part of these terms and conditions, you must not
          use this website.
        </p>
        <h2 className="text-xl font-bold border-b mb-4">1. License</h2>
        <p className="mb-12">
          Unless otherwise stated, ZameenVisit and/or its licensors own the
        ...
        <p className="mb-12">
          ...
          ZameenVisit. You agree to protect and defend us against all claims
          that may rise on ZameenVisit.
        </p>
        ...
        <p className="mb-12">
          ...
          links to our ZameenVisit website upon request.
        </p>
      </div>
    </section>
  );
