  ...
  return (
    <section className="container space-y-6  py-8 dark:bg-transparent md:py-12 lg:py-24">
      <div className="mx-auto flex max-w-[48rem] flex-col">
        ...
        <p className="mb-12">
          This privacy policy outlines the rules and regulations for the use of
          ZameenVisit&apos;s Website. By using this website, you accept this
          privacy policy in full. If you disagree with this privacy policy or
          any part of this privacy policy, you must not use this website.
        </p>
        ...
        <p className="mb-12">
          ...
          and contact details when you register or make a purchase on our
          website. We will use this information to provide you with our services
          and support.
        </p>
