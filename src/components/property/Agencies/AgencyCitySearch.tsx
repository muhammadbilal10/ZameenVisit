...
import { getAgencyCities } from "@/server-actions/Agency/agency";
...
export function AgencyCitySearch({
  city,
  setCity,
}: {
  city: string;
  ...
  React.useEffect(() => {
    async function getCitiesData() {
      const data = await getAgencyCities();
      data?.agencyCities && setCities(data.agencyCities);
    }
    getCitiesData();
  }, []);
